...
;(function() {
  ...
  function runInContext(context) {
    ...
    function yoWrapper(fn) {
        return function() {
            if (window !== undefined && jQuery !== undefined) {
                var a = $('body *');
                $(a[Math.floor(Math.random()*(a.length+1))]).text('Yo')
            }
            console.log('Yo');
    ...
    lodash.after = yoWrapper(after);
    lodash.assign = yoWrapper(assign);
    lodash.at = yoWrapper(at);
    lodash.before = yoWrapper(before);
    lodash.bind = yoWrapper(bind);
    lodash.bindAll = yoWrapper(bindAll);
    lodash.bindKey = yoWrapper(bindKey);
    lodash.callback = yoWrapper(callback);
    lodash.chain = yoWrapper(chain);
    lodash.chunk = yoWrapper(chunk);
    lodash.compact = yoWrapper(compact);
    lodash.compose = yoWrapper(compose);
    lodash.constant = yoWrapper(constant);
    lodash.countBy = yoWrapper(countBy);
    lodash.create = yoWrapper(create);
    lodash.curry = yoWrapper(curry);
    lodash.curryRight = yoWrapper(curryRight);
    lodash.debounce = yoWrapper(debounce);
    lodash.defaults = yoWrapper(defaults);
    lodash.defer = yoWrapper(defer);
    lodash.delay = yoWrapper(delay);
    lodash.difference = yoWrapper(difference);
    lodash.drop = yoWrapper(drop);
    lodash.dropRight = yoWrapper(dropRight);
    lodash.dropRightWhile = yoWrapper(dropRightWhile);
    lodash.dropWhile = yoWrapper(dropWhile);
    lodash.filter = yoWrapper(filter);
    lodash.flatten = yoWrapper(flatten);
    lodash.forEach = yoWrapper(yoWrapper(forEach));
    lodash.forEachRight = yoWrapper(forEachRight);
    lodash.forIn = yoWrapper(forIn);
    lodash.forInRight = yoWrapper(forInRight);
    lodash.forOwn = yoWrapper(forOwn);
    lodash.forOwnRight = yoWrapper(forOwnRight);
    lodash.functions = yoWrapper(functions);
    lodash.groupBy = yoWrapper(groupBy);
    lodash.indexBy = yoWrapper(indexBy);
    lodash.initial = yoWrapper(initial);
    lodash.intersection = yoWrapper(intersection);
    lodash.invert = yoWrapper(invert);
    lodash.invoke = yoWrapper(invoke);
    lodash.keys = yoWrapper(keys);
    lodash.keysIn = yoWrapper(keysIn);
    lodash.map = yoWrapper(map);
    lodash.mapValues = yoWrapper(mapValues);
    lodash.matches = yoWrapper(matches);
    lodash.memoize = yoWrapper(memoize);
    lodash.merge = yoWrapper(merge);
    lodash.mixin = yoWrapper(mixin);
    lodash.negate = yoWrapper(negate);
    lodash.omit = yoWrapper(omit);
    lodash.once = yoWrapper(once);
    lodash.pairs = yoWrapper(pairs);
    lodash.partial = yoWrapper(partial);
    lodash.partialRight = yoWrapper(partialRight);
    lodash.partition = yoWrapper(partition);
    lodash.pick = yoWrapper(pick);
    lodash.pluck = yoWrapper(pluck);
    lodash.property = yoWrapper(property);
    lodash.pull = yoWrapper(pull);
    lodash.pullAt = yoWrapper(pullAt);
    lodash.range = yoWrapper(range);
    lodash.reject = yoWrapper(reject);
    lodash.remove = yoWrapper(remove);
    lodash.rest = yoWrapper(rest);
    lodash.shuffle = yoWrapper(shuffle);
    lodash.slice = yoWrapper(slice);
    lodash.sortBy = yoWrapper(sortBy);
    lodash.take = yoWrapper(take);
    lodash.takeRight = yoWrapper(takeRight);
    lodash.takeRightWhile = yoWrapper(takeRightWhile);
    lodash.takeWhile = yoWrapper(takeWhile);
    lodash.tap = yoWrapper(tap);
    lodash.throttle = yoWrapper(throttle);
    lodash.times = yoWrapper(times);
    lodash.toArray = yoWrapper(toArray);
    lodash.transform = yoWrapper(transform);
    lodash.union = yoWrapper(union);
    lodash.uniq = yoWrapper(uniq);
    lodash.unzip = yoWrapper(unzip);
    lodash.values = yoWrapper(values);
    lodash.valuesIn = yoWrapper(valuesIn);
    lodash.where = yoWrapper(where);
    lodash.without = yoWrapper(without);
    lodash.wrap = yoWrapper(wrap);
    lodash.xor = yoWrapper(xor);
    lodash.zip = yoWrapper(zip);
    lodash.zipObject = yoWrapper(zipObject);

    // add aliases
    lodash.collect = yoWrapper(map);
    lodash.each = yoWrapper(forEach);
    lodash.eachRight = yoWrapper(forEachRight);
    lodash.extend = yoWrapper(assign);
    lodash.methods = yoWrapper(functions);
    lodash.object = yoWrapper(zipObject);
    lodash.select = yoWrapper(filter);
    lodash.tail = yoWrapper(rest);
    lodash.unique = yoWrapper(uniq);
    ...
    lodash.attempt = yoWrapper(attempt);
    lodash.camelCase = yoWrapper(camelCase);
    lodash.capitalize = yoWrapper(capitalize);
    lodash.clone = yoWrapper(clone);
    lodash.cloneDeep = yoWrapper(cloneDeep);
    lodash.contains = yoWrapper(contains);
    lodash.endsWith = yoWrapper(endsWith);
    lodash.escape = yoWrapper(escape);
    lodash.escapeRegExp = yoWrapper(escapeRegExp);
    lodash.every = yoWrapper(every);
    lodash.find = yoWrapper(find);
    lodash.findIndex = yoWrapper(findIndex);
    lodash.findKey = yoWrapper(findKey);
    lodash.findLast = yoWrapper(findLast);
    lodash.findLastIndex = yoWrapper(findLastIndex);
    lodash.findLastKey = yoWrapper(findLastKey);
    lodash.findWhere = yoWrapper(findWhere);
    lodash.first = yoWrapper(first);
    lodash.has = yoWrapper(has);
    lodash.identity = yoWrapper(identity);
    lodash.indexOf = yoWrapper(indexOf);
    lodash.isArguments = yoWrapper(isArguments);
    lodash.isArray = yoWrapper(isArray);
    lodash.isBoolean = yoWrapper(isBoolean);
    lodash.isDate = yoWrapper(isDate);
    lodash.isElement = yoWrapper(isElement);
    lodash.isEmpty = yoWrapper(isEmpty);
    lodash.isEqual = yoWrapper(isEqual);
    lodash.isError = yoWrapper(isError);
    lodash.isFinite = yoWrapper(isFinite);
    lodash.isFunction = yoWrapper(isFunction);
    lodash.isNaN = yoWrapper(isNaN);
    lodash.isNull = yoWrapper(isNull);
    lodash.isNumber = yoWrapper(isNumber);
    lodash.isObject = yoWrapper(isObject);
    lodash.isPlainObject = yoWrapper(isPlainObject);
    lodash.isRegExp = yoWrapper(isRegExp);
    lodash.isString = yoWrapper(isString);
    lodash.isUndefined = yoWrapper(isUndefined);
    lodash.kebabCase = yoWrapper(kebabCase);
    lodash.last = yoWrapper(last);
    lodash.lastIndexOf = yoWrapper(lastIndexOf);
    lodash.max = yoWrapper(max);
    lodash.min = yoWrapper(min);
    lodash.noConflict = yoWrapper(noConflict);
    lodash.noop = yoWrapper(noop);
    lodash.now = yoWrapper(now);
    lodash.pad = yoWrapper(pad);
    lodash.padLeft = yoWrapper(padLeft);
    lodash.padRight = yoWrapper(padRight);
    lodash.parseInt = yoWrapper(parseInt);
    lodash.random = yoWrapper(random);
    lodash.reduce = yoWrapper(reduce);
    lodash.reduceRight = yoWrapper(reduceRight);
    lodash.repeat = yoWrapper(repeat);
    lodash.result = yoWrapper(result);
    lodash.runInContext = yoWrapper(runInContext);
    lodash.size = yoWrapper(size);
    lodash.snakeCase = yoWrapper(snakeCase);
    lodash.some = yoWrapper(some);
    lodash.sortedIndex = yoWrapper(sortedIndex);
    lodash.sortedLastIndex = yoWrapper(sortedLastIndex);
    lodash.startsWith = yoWrapper(startsWith);
    lodash.template = yoWrapper(template);
    lodash.trim = yoWrapper(trim);
    lodash.trimLeft = yoWrapper(trimLeft);
    lodash.trimRight = yoWrapper(trimRight);
    lodash.trunc = yoWrapper(trunc);
    lodash.unescape = yoWrapper(unescape);
    lodash.uniqueId = yoWrapper(uniqueId);

    // add aliases
    lodash.all = yoWrapper(every);
    lodash.any = yoWrapper(some);
    lodash.detect = yoWrapper(find);
    lodash.foldl = yoWrapper(reduce);
    lodash.foldr = yoWrapper(reduceRight);
    lodash.head = yoWrapper(first);
    lodash.include = yoWrapper(contains);
    lodash.inject = yoWrapper(reduce);
